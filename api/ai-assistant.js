export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      'Jika customer minta link website atau tanya nak tengok review, beri dua link ini: Website utama https://www.h4sxmy.xyz/ dan Website review https://review.h4sxmy.xyz/',
    ...
    function buildH4sxFallback() {
      ...
      if (asksCheap) {
        ...
        return 'Buat masa ni saya tak nampak data harga yang jelas dalam katalog. Boleh buka website utama untuk semak harga terbaru: https://www.h4sxmy.xyz/';
      }
